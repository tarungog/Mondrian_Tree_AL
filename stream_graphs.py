...
def main():
    ...
    plt.figure()
    plt.title("wine boxplot normed MSE -- Mondrian Trees")
    plt.boxplot(corrected_mt_al_vals.T, labels=n_finals)
    plt.savefig('wine_corrected_boxplot_mt.png')

    plt.figure()
    plt.title("wine boxplot normed MSE -- Breiman trees")
    plt.boxplot(corrected_bt_al_vals.T, labels=n_finals)
    plt.savefig('wine_corrected_boxplot_bt.png')
